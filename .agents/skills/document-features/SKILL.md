...
Do NOT modify `AGENTS.md` — it only references `AGENTS.md`.
...
- **Overwriting AGENTS.md.** Only append the reference line. Preserve all existing content.
